      ...
      <div className="banner-content flex items-start flex-col gap-[2rem] md:gap-[10rem] sm:gap-[6rem]  lg:gap-[14rem]">
        <div className="left-content  mx-3">
          <H1
            ...
            className=" text-2xl mb-2 sm:text-4xl sm:mb-4 md:text-6xl md:mb-8 lg:text-8xl lg:mb-12 font-semibold"
          />
          <Para
            title="Premium Athletic Footwear"
            className="text-sm mb-2 sm:text-md sm:mb-2 md:text-lg md:mb-2 lg:text-2xl lg:mb-3"
          />
        ...
        <div className="rightbox flex border-[1px] rounded-xl bg-white p-3 self-end flex-row mx-3 gap-5">
          ...
          <div className="basis-[30%] flex flex-col justify-between items-center">
            <div className="">
              <H6 title="Marathon Master" className="text-lg font-bold mb-3" />
              <Para title="$140.00" className="text-sm" />
            </div>
            <button className="uppercase border-[1px] border-black rounded-full px-2 py-1 text-sm ">Add to Cart</button>
          </div>
        </div>
      </div>
    </>
